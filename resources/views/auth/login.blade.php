...
<div class="flex h-screen">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="space-y-1">
                    ...
                    <input
                        ...
                        class="block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors {{ $errors->has('email') ? 'border-red-300 bg-red-50' : '' }}"
                    >
                </div>
    ...
    <div class="hidden lg:flex lg:w-7/12 flex-col justify-between p-16" style="background:#0f172a;">
        ...
        <p class="text-xs mt-8" style="color:rgba(255,255,255,0.2);">Chemical Stock OS &copy; {{ date('Y') }} — Enterprise Edition</p>
    </div>
</div>
